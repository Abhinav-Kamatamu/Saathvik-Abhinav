...
backgroud_image = pygame.image.load('CodeFiles/TestMap_2.png')
backgroud_size = pygame.image.load('CodeFiles/TestMap_2.png').get_size()
...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y, group, obstacles, scale, backgroundsize):
        ...
        self.images_up = [pygame.transform.scale(pygame.image.load('CodeFiles/Character/Up/Up_1.png'), self.new_scale),
                          pygame.transform.scale(pygame.image.load('CodeFiles/Character/Up/Up_2.png'), self.new_scale),
                          pygame.transform.scale(pygame.image.load('CodeFiles/Character/Up/Up_3.png'), self.new_scale)]
        self.images_down = [pygame.transform.scale(pygame.image.load('CodeFiles/Character/Down/Down_1.png'), self.new_scale),
                            pygame.transform.scale(pygame.image.load('CodeFiles/Character/Down/Down_2.png'), self.new_scale),
                            pygame.transform.scale(pygame.image.load('CodeFiles/Character/Down/Down_3.png'), self.new_scale)]
        self.images_left = [pygame.transform.scale(pygame.image.load('CodeFiles/Character/Left/Left_1.png'), self.new_scale),
                            pygame.transform.scale(pygame.image.load('CodeFiles/Character/Left/Left_2.png'), self.new_scale),
                            pygame.transform.scale(pygame.image.load('CodeFiles/Character/Left/Left_3.png'), self.new_scale)]
        self.images_right = [pygame.transform.scale(pygame.image.load('CodeFiles/Character/Right/Right_1.png'), self.new_scale),
                             pygame.transform.scale(pygame.image.load('CodeFiles/Character/Right/Right_2.png'), self.new_scale),
                             pygame.transform.scale(pygame.image.load('CodeFiles/Character/Right/Right_3.png'), self.new_scale)]
        self.images_static = [pygame.transform.scale(pygame.image.load('CodeFiles/Character/Up/Up_Rest.png'), self.new_scale),
                              pygame.transform.scale(pygame.image.load('CodeFiles/Character/Down/Down_Rest.png'), self.new_scale),
                              pygame.transform.scale(pygame.image.load('CodeFiles/Character/Left/Left_Rest.png'), self.new_scale),
                              pygame.transform.scale(pygame.image.load('CodeFiles/Character/Right/Right_Rest.png'),
                                                     self.new_scale)]
...
class Game:
    ...
    def menuScreen(self):
        ...
        self.menu_image = pygame.image.load('CodeFiles/Menu.png')
        self.play_button_image = pygame.image.load('CodeFiles/Play_button.png')
        self.play_rect = self.play_button_image.get_rect(topleft=(350, 300))
        self.image_2 = pygame.image.load('CodeFiles/Play_button.png')
    ...
    def initiateMainGame(self):
        ...
        self.obstacle_list = [  # (Position, Size)
            [(0, 0), (200, 1500)],
            [(200, 0), (1300, 150)],
            [(1300, 150), (200, 1350)],
            [(200, 1350), (1100, 150)],
    ...
    def fade(self):
        if not self.un_fade:
            ...
            if self.fade_value >= 256:
                ...
                self.un_fade = True
                # Plays music
                pygame.mixer.music.load('DevelopmentFiles/Draft (1).wav')
